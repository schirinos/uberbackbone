...
(function (factory) {
  ...
  if (typeof define === 'function' && define.amd) {
    define(['underscore', 'backbone', 'rivets', 'exports'], factory);
  }

  // Next for Node.js or CommonJS.
  else if (typeof exports === 'object') {
    factory(require('underscore'), require('backbone'), require('rivets'), exports);
  }

  // Finally, as a browser global.
  else {
    factory(_, Backbone, Rivets, {});
  }
        ...
        cleanUp: function (options) {
            ...
            return $.when.apply($, childq).then(function (){
                ...
                return self.$el.promise().done(function () {
                    // Remove rivets binding
                    if (self.rivets) self.rivets.unbind();
